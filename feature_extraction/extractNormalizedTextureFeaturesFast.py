...
preds_dirs = ["/mnt/data/model_to_train/results_round_1/results_inference/pred/"]
...
output_excel_path = f'//mnt/data/model_to_train/results_round_1/results_inference/extract_features/segmentation_summary_{net}_{experiment}.xlsx'
df.to_excel(output_excel_path, index=False)
print(f"\nSummary Excel file saved to: {output_excel_path}")

# Optionally, save the DataFrame to a JSON file as well
output_json_path = f'/mnt/data/model_to_train/results_round_1/results_inference/extract_features/segmentation_summary_{net}_{experiment}.json'
